...
Provider Tri
t.me/GarzProject
fb.me/tegarprayuda.1654
*/
echo @color("white","───────────────────────────────────────────────\n");
echo @color("green","          TOOLS DOR TRI | tegarpryd_           \n");
echo @color("white","───────────────────────────────────────────────\n");
echo @color('purple', "Masukkan Nomor Tri Anda Tuan \t\t: ");
$nomor = trim(fgets(STDIN));
$login = login($nomor);
echo @color('green', $login['message']."\n");
echo @color('purple', "Masukkan Kode OTPNYA COK\t\t: ");
...
if (strpos(json_encode($login), '"status":true')) {
    ...
    switch ($pilih) {
        ...
        default:
            echo @color('red', "Pilih Paketnya tuan\n\n");
            goto cek;
            break;
    }
    $cek = cek($prodid);
